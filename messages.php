...
<div class="user_details column" style="margin-bottom: -1px;">
...
<div class="main_column column" id="main_column" style="width: 72%;">
    <?php
    if ($user_to != "new") {
...
<div class="user_details column" id="conversations" style="margin-top: 25px;">
    <h4>Conversations</h4>
